...
public class BrandByEggsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_brand_eggs, container, false);

        // Init view
        recyclerView = view.findViewById(R.id.recycler_eggs);
        ...
        adapter = new BrandAdapter(getActivity(),database.getBrandByEggs(), key);
